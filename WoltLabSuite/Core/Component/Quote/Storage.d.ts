...
export declare function saveQuote(objectType: string, objectId: number, message: string, 
/** @deprecated 6.2 Used for legacy implementations only. */
className?: string): Promise<Message & Quote & {
    uuid: string;
}>;
export declare function saveFullQuote(objectType: string, objectId: number, 
/** @deprecated 6.2 Used for legacy implementations only. */
className?: string): Promise<Message & Quote & {
    uuid: string;
}>;
